...
{/* <div  style ={{flex:2}}> 
        ...
        {width>=1000?<div className ="card"  style ={{display:"flex", flexDirection:"row", marginTop:"20%",height:"fit-content",background:"rgb(9, 48, 18)", opacity:0.7, fontSize:"30px", color:"whitesmoke"}}>
        <div  style ={{flex:6, padding:"12px 12px 12px 12px"}}>
