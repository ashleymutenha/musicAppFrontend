...
function Home(){
 ...
 console.log(width)
    ...
    return (
        ...
        {width >=1300?<div style ={{width:width}}>
        ...
        { info.data.map((data)=>
        {
          ...
          <div style ={{display:"flex",marginLeft:"3%", marginTop:"1%",background:"rgb(243, 240, 243)",width:"fit-content", height:"300px",borderRadius:"12px"}}>
             <div>
             <img src ={data.image} alt ="logo" style ={{height:"310px",width:"35rem",
             borderTopLeftRadius:"13px", borderBottomLeftRadius:"13px"}} class ="corousel-item"/>

             </div>
             <div style ={{borderRadius:"13px",width:"35rem",}}>
    ...
    marginTop:"12px", marginLeft:"3%",marginBottom:"5px"}}>
     ...
     <div class ="mt-1"><BsFacebook className ="fs-4" style ={{color:"lightgrey"}}/> <BsGoogle className ="fs-4 " style ={{color:"lightgrey"}}/>
      <BsLinkedin className ="fs-4" style ={{color:"lightgrey",marginLeft:"4px"}}/></div>
        ...
        {width<1300 ?<div><div style ={{height:"fit-content",width:width, marginTop:"124px", background:""}} className ="content" >
            <div>
        ...
        {width>700?<div style ={{borderBottom:"1px solid grey",height:"fit-content" }}>
        <Carousel style ={{borderRadius:"13px",background:"#397453", marginTop:"",marginLeft:"3%"}} controls ={false} indicators ={false} fade ={false}>
        { info.data.map((data)=>
        {
          return(
            <Carousel.Item Interval ={100}  style={{opacity:1, transition:"opacity 0.5s !important"}}>
          <div style ={{display:"flex",marginLeft:"3%", marginTop:"1%",background:"rgb(243, 240, 243)",width:"fit-content", height:"300px",borderRadius:"12px"}}>
             <div>
             <img src ={data.image} alt ="logo" style ={{height:"310px",width:"20rem",
             borderTopLeftRadius:"13px", borderBottomLeftRadius:"13px"}} class ="corousel-item"/>

             </div>
             <div style ={{borderRadius:"13px",width:"19rem",}}>
             {/* <button className ="btn btn-secondary rounded-pill mt-2" style ={{marginLeft:"10px",position:"fixed"}}>Learn More <BsArrowRight/></button> */}
              <div className ="btn-detail" style ={{marginTop:"6px",}}>
                <a href ="#" style ={{textDecoration:"none",color:"#ffff"}}>Learn More</a>
              </div>
              ...
              <div style ={{marginTop:"%",width:"18rem",borderRadius:"12px"}}>

                 <div>
                <div className ="text-muted " style ={{fontFamily:'cursive' ,marginTop:"2px",fontSize:"15px", marginLeft:"10%",borderRadius:"12px"}}>{data.description}</div>
                <div>
                </div>
            </div>
        ...
        <div style ={{borderRight:"1px solid grey",paddingRight:"5%",paddingTop:"3%"}}>
        <div style = {{border:"1px solid lightgrey" ,
         width:"fit-content", height:"200px", marginLeft:"7%",padding:"10px 10px 10px 10px",
          borderRadius:"12px", background:"hsl(129, 29%, 37%)", color:"white",fontFamily:'cursive' ,marginTop:"25px",fontSize:"20px", position:"",marginRight:"2%"}}>
         <div>
         <BsStars className ="fs-1 mt-1"   style ={{borderRadius:"",color:"darkgreen", marginLeft:"80%"}}/>
         </div>
          {homeInfo.Introduction}
    ...
    marginTop:"12px", marginLeft:"3%",marginBottom:"5px"}}>
     ...
     <div class ="mt-1"><BsFacebook className ="fs-4" style ={{color:"lightgrey"}}/> <BsGoogle className ="fs-4 " style ={{color:"lightgrey"}}/>
      <BsLinkedin className ="fs-4" style ={{color:"lightgrey",marginLeft:"4px"}}/></div>
         ...
         <div  style ={{background:"#ffff", display:"flex"}} className ="mb-3">
        <div className ="mb-2" style = {{border:"1px solid darkgreen" , width:"600px", height:"fit-content",padding:"10px 10px 10px 10px",
          borderRadius:"12px" ,marginTop:"12px",fontSize:"20px", marginLeft:"4%",}}>
                   <span> <BsMagic className ="fs-1 mt-1"   style ={{borderRadius:"",color:"goldenrod", marginLeft:"2%",opacity:"0.6"}}/>
                    <p className ="fs-1 text-success"> Mission</p></span>
        ...
        <div className ="mb-2" style = {{border:"1px solid darkgreen" , width:"600px", height:"fit-content", marginLeft:"1%", marginRight:"1%",padding:"10px 10px 10px 10px",
          borderRadius:"12px" ,marginTop:"12px",fontSize:"20px"}}>
                   <span> <BsSun className ="fs-1 mt-1"   style ={{borderRadius:"",color:"goldenrod", marginLeft:"2%",opacity:"0.6"}}/>
                    <p className ="fs-1 text-success"> Vision</p></span>
