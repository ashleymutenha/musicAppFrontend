...
import { BsArrowRight, BsCollectionPlay, BsMusicNote, BsMusicNoteList, BsMusicPlayerFill, BsPerson, BsPlusCircle, BsPlusSlashMinus, BsSoundwave, BsSpeakerFill } from "react-icons/bs"
...
export default function Artist(){
  ...
  // function to check if an artist is saved to user's favourites
    ...
    function checkIfFavourite(artist){
        // var _faves =localStorage.getItem("faves")
         console.log(faves)
        let responseObject =false
        for(var fave of faves){
            if(fave.artist==artist){
                responseObject =true
            }
        }
    ...
    function getArtistInfo(){
       ...
       const  url ="https://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist="+artist+"&api_key=4c6a539445c920ae57b3868a7a8612ab&format=json"
        ...
        then((_res)=>{
            ...
            // console.log(singer.artist.bio.summary.split("<a"))
        })
